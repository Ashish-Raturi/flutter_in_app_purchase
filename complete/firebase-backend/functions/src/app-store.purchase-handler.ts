...
export class AppStorePurchaseHandler extends PurchaseHandler {
  ...
  private async handleValidation(
    ...
    console.warn("handling verification");
    ...
    console.warn("updating productio");
    ...
    for (const product of products) {
      ...
      console.warn("updating productio ifnfo");
      // Process the product
    ...
    console.warn("verification done & updated the code also");
    return true;
  }
  ...
  handleServerEvent = functions.https.onRequest(async (
    ...
    for (const iap of latestReceipts) {
      ...
      switch (productData.type) {
        case "SUBSCRIPTION":
          try {
            console.log("updating the purchase in ");
